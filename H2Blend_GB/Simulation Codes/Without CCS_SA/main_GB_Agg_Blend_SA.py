...
from multinet_GB_Agg_Blend_SA import *
    ...
    for price_level, price_list in price_levels.items():
        ...
        #################################################    
            ...
            for gens_flag, scenario_name in plan_scenarios.items():
                ...
                Case_name = 'Cooperative_SA'  
                
                
                if G2G_sw=='Grey':
                    Case_name = 'GreyH2_Cooperative_SA'  
                    if C_EZ_cfd_sw =='Sub_H2green':
                        Case_name = 'GreyH2_Sub_H2green_Cooperative_SA'  
                    if C_EZ_cfd_sw =='No_SubH2green':
                        Case_name = 'GreyH2_Cooperative_SA'  
                        
                if G2G_sw=='Blue':
                    Case_name = 'BlueH2_Cooperative_SA'  
                    if C_EZ_cfd_sw =='Sub_H2green':
                        Case_name = 'BlueH2_Sub_H2green_Cooperative_SA'  
                    if C_EZ_cfd_sw =='No_SubH2green':
                        Case_name = 'BlueH2_Cooperative_SA' 
        
                if S4_Emiss==1:
                    Case_name = 'CfD_S4Emiss_Cooperative_SA'
