    ...
    for price_level, price_list in price_levels.items():
        ...
        #################################################    
            ...
            for gens_flag, scenario_name in plan_scenarios.items():
                ...
                Case_name = 'CfD_Cooperative'  
                
                
                if G2G_sw=='Grey':
                    Case_name = 'CfD_GreyH2_Cooperative'  
                    if C_EZ_cfd_sw =='Sub_H2green':
                        Case_name = 'CfD_GreyH2_Sub_H2green_Cooperative'  
                    if C_EZ_cfd_sw =='No_SubH2green':
                        Case_name = 'CfD_GreyH2_Cooperative'  
                        
                if G2G_sw=='Blue':
                    Case_name = 'CfD_BlueH2_Cooperative'  
                    if C_EZ_cfd_sw =='Sub_H2green':
                        Case_name = 'CfD_BlueH2_Sub_H2green_Cooperative'  
                    if C_EZ_cfd_sw =='No_SubH2green':
                        Case_name = 'CfD_BlueH2_Cooperative' 
        
                if S4_Emiss==1:
                    Case_name = 'CfD_S4Emiss_Cooperative'
